...
export default function OnboardingForm() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex min-h-0 flex-1 flex-col rounded-[24px] border border-[#d7dfdc] bg-white/80 p-5 shadow-sm md:p-6">
        <h2 className="shrink-0 font-serif text-2xl font-bold leading-tight text-[#012825] md:text-3xl">
          {currentStep.title}
        </h2>
        ...
        {validationError ? (
          <p className="mt-3 shrink-0 text-sm font-medium text-red-700">
            {validationError}
          </p>
        ) : error ? (
          <p className="mt-3 shrink-0 text-sm font-medium text-red-700">
        ...
        <div className="mt-4 flex shrink-0 items-center justify-between gap-3">
          <button
            type="button"
            className="rounded-full border border-[#b8c8c3] bg-white/70 px-5 py-2.5 text-sm font-medium text-[#012825] transition hover:bg-white disabled:cursor-not-allowed disabled:opacity-50"
            onClick={handleBack}
          ...
          <button
            ...
            className="rounded-full bg-[#012825] px-6 py-2.5 text-sm font-medium text-white transition hover:bg-[#0b3a35] disabled:cursor-not-allowed disabled:opacity-60"
    ...
    <div className="grid gap-2">
      {options.map((option) => {
        ...
        return (
          <label
            key={option.value}
            className={`flex min-h-[52px] cursor-pointer items-center gap-3 rounded-2xl border px-4 py-3 text-sm transition ${
              checked
