  ...
  return (
    <main className="min-h-screen">
      <section className="mx-auto max-w-6xl px-6 py-8">
        ...
        <div className="mt-10">
          <h3 className="text-xl font-semibold text-[var(--text-primary)]">Recommended for You</h3>
          <p className="mt-1 text-sm text-[var(--text-secondary)]">Articles tailored to your learning goals</p>
          <RecommendedArticles />
        </div>
      </section>
    </main>
